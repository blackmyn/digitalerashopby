...
namespace DLL.Migrations
{
    ...
    [Migration("20240419011339_fourhone")]
    partial class fourhone
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DLL.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DLL.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DLL.Models.Delivery", b =>
                {
                    b.HasOne("DLL.Models.Order", "Order")
                        .WithOne("Delivery")
                        .HasForeignKey("DLL.Models.Delivery", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DLL.Models.Payment", b =>
                {
                    b.HasOne("DLL.Models.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("DLL.Models.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
